...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("locale", sa.String(5), nullable=False, server_default="ja"),
    ...
    op.create_table(
        "books",
        sa.Column("id", UUID(as_uuid=True), primary_key=True),
        sa.Column("isbn_10", sa.String(10), nullable=True, index=True),
        sa.Column("isbn_13", sa.String(13), nullable=True, index=True),
        sa.Column("title", sa.String(500), nullable=False),
        sa.Column("subtitle", sa.String(500), nullable=True),
        sa.Column("series_title", sa.String(200), nullable=True, index=True),
        sa.Column("volume_number", sa.String(20), nullable=True),
        sa.Column("authors", JSONB, nullable=False, server_default="'[]'::jsonb"),
        ...
        sa.Column("cover_image_original_url", sa.String(1000), nullable=True),
        sa.Column("categories", JSONB, nullable=False, server_default="'[]'::jsonb"),
